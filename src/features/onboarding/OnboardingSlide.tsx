    ...
    <View style={[styles.slide, { width }]}> 
      <Animated.View entering={FadeInDown.springify()} style={[styles.visual, { backgroundColor: theme.primarySoft, borderColor: theme.border }]}> 
        ...
        <View style={[styles.icon, { backgroundColor: theme.primary }]}> 
          <Ionicons name={item.icon} color={theme.white} size={54} />
        </View>
        <View style={[styles.miniCard, { backgroundColor: theme.surface, borderColor: theme.border }]}> 
          ...
          <AppText variant="caption" weight="bold">Private by design</AppText>
        </View>
      </Animated.View>
      <Animated.View entering={FadeInUp.delay(100).springify()} style={styles.copy}> 
        ...
        <AppText variant="display" weight="black" align="center">{item.title}</AppText>
...
const styles = StyleSheet.create({
  ...
  visual: { height: 280, borderRadius: radii.hero, borderWidth: 1, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  orbit: { position: 'absolute', width: 210, height: 210, borderRadius: 105, borderWidth: 1, opacity: 0.25 },
  icon: { width: 112, height: 112, borderRadius: 38, alignItems: 'center', justifyContent: 'center', transform: [{ rotate: '-5deg' }] },
