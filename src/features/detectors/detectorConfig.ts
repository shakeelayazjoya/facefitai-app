...
export const detectors: DetectorConfig[] = [
  ...
  { kind: 'emotion', title: 'Emotion & Smile', description: 'Smile meter & emotion analysis.', emptyTitle: 'No result yet', uploadTitle: 'Expression scan', uploadDescription: 'Upload a clear front-facing selfie.', uploadAction: 'Upload selfie', cameraAction: 'Take photo', loadingLabel: 'Analyzing expression', filePrefix: 'face-expression' },
];
