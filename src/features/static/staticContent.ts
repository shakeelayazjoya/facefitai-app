...
export const staticContent: Record<string, StaticContent> = {
  ...
  faqs: { title: 'FAQs', description: 'Quick answers.', sections: [{ heading: 'Accuracy', body: ['Use a clear, front-facing selfie.'] }, { heading: 'Saving', body: ['Sign in to save and compare scans.'] }, { heading: 'Tools', body: ['Face, eyes, nose, lips, age, symmetry, emotion & smile.'] }] },
