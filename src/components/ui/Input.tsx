...
const styles = StyleSheet.create({ wrap: { gap: spacing.xs }, label: { fontSize: 13, fontWeight: '700', paddingLeft: spacing.xs }, shell: { minHeight: 52, borderRadius: radii.lg, borderWidth: 1, paddingHorizontal: spacing.lg, flexDirection: 'row', alignItems: 'center', gap: spacing.sm }, input: { flex: 1, fontSize: 15, paddingVertical: spacing.md }, error: { fontSize: 12, paddingLeft: spacing.xs } });
