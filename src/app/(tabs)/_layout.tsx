...
export default function TabsLayout() {
  ...
  return <Tabs tabBar={(props) => <AnimatedTabBar {...props} />} screenOptions={{ headerShown: false, tabBarHideOnKeyboard: true, animation: 'shift', sceneStyle: { backgroundColor: theme.background } }}>
    ...
    <Tabs.Screen name="lips" options={{ title: 'Lips' }} /><Tabs.Screen name="emotion" options={{ title: 'Emotion' }} /><Tabs.Screen name="age" options={{ title: 'Age' }} /><Tabs.Screen name="symmetry" options={{ title: 'Symmetry' }} />
